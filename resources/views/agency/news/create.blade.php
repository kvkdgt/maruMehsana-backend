...
@section('header-title', 'Create News Article')
...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p class="form-description">Fill in the details below to create a new news article</p>
        </div>

        <form action="{{ route('agency.news.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" name="excerpt" class="form-control textarea {{ $errors->has('excerpt') ? 'error' : '' }}" 
                          placeholder="Brief description of the article (max 500 characters)" required>{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <div class="form-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="file-input-container">
                    ...
                    <label for="image" class="file-input-label" id="file-label">
                        ...
                        <div>
                            <div style="font-weight: 600; margin-bottom: 0.25rem;">Choose an image</div>
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            label.innerHTML = `
                ...
                <div>
                    <div style="font-weight: 600; margin-bottom: 0.25rem;">Image selected</div>
